...
$("#course_link").mouseover(function(){
            ...
            $('#inner').append('<div id="s1" class="carousel-item"><img class="d-block w-100" src="img/course4.jpg" alt="Chrome River Campground" /></div>');
            $('#inner').append('<div id="s2" class="carousel-item"><img class="d-block w-100" src="img/course5.jpg" alt="Chrome River Campground" /></div>');
            $(".carousel").carousel("cycle");
